      ...
      <div class="grid grid-cols-1 gap-6 lg:grid-cols-3 mb-6">
        <div class="rounded-2xl flex-col dark:bg-slate-900/70 bg-white flex">
          <div class="flex-1 p-6">
              ...
              <div class="flex items-center justify-center">
                <div
                  ...
                  <span class="inline-flex justify-center items-center w-4 h-4 mr-1"><svg viewBox="0 0 24 24" width="14"
                    ...
                    fill="currentColor"
                    d="M7.41,15.41L12,10.83L16.59,15.41L18,14L12,8L6,14L7.41,15.41Z"></path></svg></span><span>12%</span>
                </div>
              </div>
              <!--              <div class="flex items-center justify-center">-->
              <!--                <button-->
            ...
            <div class="justify-between items-center flex">
              <div class="flex items-center justify-center">
                <div><h3 class="text-lg leading-tight text-gray-500 dark:text-slate-400">Bugünkü Siparişler</h3>
        ...
        <div class="rounded-2xl flex-col dark:bg-slate-900/70 bg-white flex">
          <div class="flex-1 p-6">
              ...
              <div class="flex items-center justify-center">
                <div
                  ...
                  <span class="inline-flex justify-center items-center w-4 h-4 mr-1"><svg viewBox="0 0 24 24" width="14"
                                                                                          ...
                                                                                          class="inline-block"><path
                    fill="currentColor"
                    d="M7.41,8.58L12,13.17L16.59,8.58L18,10L12,16L6,10L7.41,8.58Z"></path></svg></span><span>12%</span>
                </div>
              </div>
              <div class="flex items-center justify-center">
                <button
                  class="inline-flex justify-center items-center whitespace-nowrap focus:outline-none transition-colors focus:ring duration-150 border cursor-pointer rounded border-gray-100 dark:border-slate-800 ring-gray-200 dark:ring-gray-500 bg-gray-100 text-black dark:bg-slate-800 dark:text-white hover:bg-gray-200 hover:dark:bg-slate-700 p-1"
                  type="button" icon-w="w-4" icon-h="h-4"><span class="inline-flex justify-center items-center w-6 h-6"><svg
                  viewBox="0 0 24 24" width="16" height="16" class="inline-block"><path fill="currentColor"
            ...
            <div class="justify-between items-center flex">
              <div class="flex items-center justify-center">
                <div><h3 class="text-lg leading-tight text-gray-500 dark:text-slate-400">Bugünkü Satış</h3>
                  <h1 class="text-3xl leading-tight font-semibold">
                    <div>₺{{ todaySale }}</div>
                  </h1>
                </div>
...
<!--                                <svg viewBox="0 0 24 24" width="48" height="48" class="inline-block">-->
                                ...
                                <!--                                </path>-->
                                <!--                                </svg>-->
                                              <svg class="inline-block" width="48" height="" fill="none"
        ...
        <div class="rounded-2xl flex-col dark:bg-slate-900/70 bg-white flex">
          <div class="flex-1 p-6">
              ...
              <div class="flex items-center justify-center">
                <div
                  ...
                  <span class="inline-flex justify-center items-center w-4 h-4 mr-1"><svg viewBox="0 0 24 24" width="14"
                                                                                          ...
                                                                                          class="inline-block"><path
                    fill="currentColor"
                    d="M11,15H13V17H11V15M11,7H13V13H11V7M12,2C6.47,2 2,6.5 2,12A10,10 0 0,0 12,22A10,10 0 0,0 22,12A10,10 0 0,0 12,2M12,20A8,8 0 0,1 4,12A8,8 0 0,1 12,4A8,8 0 0,1 20,12A8,8 0 0,1 12,20Z"></path></svg></span><span>Overflow</span>
                </div>
              </div>
              <div class="flex items-center justify-center">
                <button
            ...
            <div class="justify-between items-center flex">
              <div class="flex items-center justify-center">
                <div><h3 class="text-lg leading-tight text-gray-500 dark:text-slate-400">Bugün Kayıt Olan
                  Kullanıcılar</h3>
                  <h1 class="text-3xl leading-tight font-semibold">
                    <div>{{ todayUser }}</div>
                  </h1>
      ...
      <div class="grid grid-cols-1 gap-6 lg:grid-cols-3 mb-6">
        <div class="rounded-2xl flex-col dark:bg-slate-900/70 bg-white flex">
          <div class="flex-1 p-6">
            ...
            <div class="justify-between items-center flex">
              <div class="flex items-center justify-center">
                <div><h3 class="text-lg leading-tight text-gray-500 dark:text-slate-400">Siparişler</h3>
                  <h1 class="text-3xl leading-tight font-semibold">
                    <div> {{ order_count }}</div>
                  </h1>
                </div>
              ...
              <div class="flex items-center justify-center">
                <span
                  ...
                  <svg class="" width="48" height="48" fill="none" stroke="currentColor" viewBox="0 0 24 24"
        ...
        <div class="rounded-2xl flex-col dark:bg-slate-900/70 bg-white flex">
          <div class="flex-1 p-6">
            ...
            <div class="justify-between items-center flex">
              <div class="flex items-center justify-center">
                <div><h3 class="text-lg leading-tight text-gray-500 dark:text-slate-400">Kasa</h3>
                  <h1 class="text-3xl leading-tight font-semibold">
              ...
              <!--                                class="inline-block"><path-->
              <!--                                fill="currentColor"-->
              <!--                                d="M16 17V19H2V17S2 13 9 13 16 17 16 17M12.5 7.5A3.5 3.5 0 1 0 9 11A3.5 3.5 0 0 0 12.5 7.5M15.94 13A5.32 5.32 0 0 1 18 17V19H22V17S22 13.37 15.94 13M15 4A3.39 3.39 0 0 0 13.07 4.59A5 5 0 0 1 13.07 10.41A3.39 3.39 0 0 0 15 11A3.5 3.5 0 0 0 15 4Z"></path></svg></span>-->
              <!--              </div>-->

              <div class="flex items-center justify-center">
                              <span
                                class="inline-flex justify-center items-center  h-16 text-amber-500">
                                <svg class="" width="48" height="48" fill="none" stroke="currentColor"
        ...
        <div class="rounded-2xl flex-col dark:bg-slate-900/70 bg-white flex">
          <div class="flex-1 p-6">
            ...
            <div class="justify-between items-center flex">
              <div class="flex items-center justify-center">
                <div><h3 class="text-lg leading-tight text-gray-500 dark:text-slate-400">Kayıtlı Kullanıcı</h3>
                  <h1 class="text-3xl leading-tight font-semibold">
                    <div>{{ total_user }}</div>
                  </h1>
                </div>
