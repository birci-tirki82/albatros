...
<template>
  ...
  <FrontendLayout >
    ...
    <div class="container mx-auto grid grid-cols-4 gap-6 pt-4 pb-16 items-start">
      ...
      <div class="sm:col-span-2 md:col-span-1 lg:col-span-1 col-span-4  bg-white px-4 pb-6 shadow rounded overflow-hidden">
        <div class="divide-y divide-gray-200 space-y-5">
          <div>
            <h3 class="text-xl text-gray-800 mb-3 uppercase font-medium"><strong>Alt Kategoriler</strong></h3>
            <div class="space-y-2 ">
          ...
          <div v-if="writers" class="pt-4">
            <h3 class="text-xl text-gray-800 mb-3 uppercase font-medium"><strong>Yazarlar</strong></h3>
            <div class="space-y-2">

              <div v-for="writer in writers" class="flex items-center">
                <input type="checkbox" name="brand-1" id="brand-1"
                       class="text-red-500 focus:ring-0 rounded-sm cursor-pointer">
                <label for="brand-1" class="text-gray-600 ml-3 cusror-pointer">{{ writer.name + ' ' + writer.lastname }}</label>
          ...
          <div class="pt-4">
            <h3 class="text-xl text-gray-800 mb-3 uppercase font-medium"><strong>Yayıncılar</strong></h3>
            <div class="space-y-2">
          ...
          <div class="pt-4">
            <h3 class="text-xl text-gray-800 mb-3 uppercase font-medium"><strong>Fiyat Aralığı</strong></h3>
      ...
      <div class="col-span-4 lg:col-span-3 md:col-span-3 sm:col-span-2 ">
        <div class="flex items-center mb-4">
          ...
          <div class="flex gap-2 ml-auto">
            <div
              class="border border-primary w-10 h-9 flex items-center justify-center text-black bg-primary rounded cursor-pointer">
          ...
          <div v-for="prod in itemsPaginated"  class="bg-white shadow rounded overflow-hidden group lg:col-span-1 md:col-span-1 sm:col-span-3 col-span-3">
            <div class="relative">
              ...
              <div class="absolute inset-0 bg-black bg-opacity-40 flex items-center
                ...
                <!--                <a href="#"-->
                <!--                   class="text-black text-lg w-9 h-8 rounded-full bg-primary flex items-center justify-center hover:bg-gray-800 transition"-->
                <!--                   title="view product">-->
            ...
            <div class="pt-4 pb-3 px-4">
              ...
              <Link v-if="prod.product.tur === 'book'" :href="route('urun', { slug: prod.product.slug, id:prod.product_id })">

                <h4 class=" font-medium text-x mb-2 text-gray-800 hover:text-red-500 transition">{{ prod.product.name }}</h4>
              </Link>
              <Link v-else-if="prod.product.tur === 'journal'" :href="route('urun', { slug: prod.product.slug, id:prod.product_id })">
            ...
            <Link @click="addCart(prod.product.id)"
                  class="block w-full py-1 text-center text-black bg-primary border border-primary rounded-b hover:bg-transparent hover:text-red-500 transition">
              Sepete Ekle
            </Link>
          </div>


          <div class="bg-white shadow rounded overflow-hidden group lg:col-span-1 md:col-span-1 sm:col-span-3 col-span-3 ">
            <div class="relative">
              <img src="" alt="product 1" class="w-full bg-cover">
              <div class="absolute inset-0 bg-black bg-opacity-40 flex items-center
                    justify-center gap-2 opacity-0 group-hover:opacity-100 transition">
                <a href="product.html"
                   class="text-black text-lg w-9 h-8 rounded-full bg-primary flex items-center justify-center hover:bg-gray-800 transition"
            ...
            <div class="pt-4 pb-3 px-4">
              <a href="#">
                <h4 class="uppercase font-medium text-lg mb-2 text-gray-800 hover:text-red-500 transition">
                  Kitap adı: Lorem ipsum dolor sit.</h4>
              </a>
              <div class="text-sm my-2">
                <p><span class="font-bold">Yazar: </span>Lorem, ipsum.</p>
                <p><span class="font-bold">Çeviren: </span>Lorem, ipsum.</p>
                <p><span class="font-bold">Yayınevi: </span>Lorem, ipsum.</p>
              </div>
            ...
            <a href="#"
               class="block w-full py-1 text-center text-black bg-primary border border-primary rounded-b hover:bg-transparent hover:text-red-500 transition">Sepete Ekle
              <i class="ml-4 fa-solid fa-bag-shopping"></i>
            </a>
          </div>
          <div class="bg-white shadow rounded overflow-hidden group lg:col-span-1 md:col-span-1 sm:col-span-3 col-span-3">
            <div class="relative">
    ...
    <div class="items-center p-4 lg:px-6 border-t border-gray-500 dark:border-slate-800">
      <BaseLevel>
        <BaseButtons>
          <BaseButton
